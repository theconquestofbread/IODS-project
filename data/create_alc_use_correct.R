...
#Since my original data wrangling exercise contained
#errors, I used Reijo Sund's code to produce the
#corret data. 
...
library(openxlsx)
write.xlsx(pormath,file="~/IODS-project/data/alc_use.xlsx")
